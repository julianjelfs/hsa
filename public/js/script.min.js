...
(function($, window) {
...
} ]), angular.module("myApp").controller("GalleryCtrl", [ "$scope", "$compile", "$location", "$http", function($scope, $compile) {
    ...
    $scope.clear = function() {
        ...
        currentFiles.splice(index, 1), holder.innerHTML = "";
        for (var i = 0; i < currentFiles.length; i++) previewfile(currentFiles[i], i);
