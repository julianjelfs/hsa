...
(function($, window) {
...
} ]), angular.module("myApp").controller("GalleryCtrl", [ "$scope", "$location", "$http", function($scope) {
    ...
    function readfiles(files) {
        for (var i = 0; i < files.length; i++) currentFiles.push(files[i]), previewfile(files[i]);
    }
    ...
    }, $scope.remove = function() {}, holder.ondragover = function() {
