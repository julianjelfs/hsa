...
(function($, window) {
    ...
    function previewfile(file) {
        if (acceptedTypes[file.type] === !0) {
            ...
            reader.onload = function(event) {
                var image = new Image();
                image.src = event.target.result, image.width = 400, holder.appendChild(image);
            }, reader.readAsDataURL(file);
        } else holder.innerHTML += "<p>Uploaded " + file.name + " " + (file.size ? (0 | file.size / 1024) + "K" : ""), 
        console.log(file);
    }
    function readfiles(files) {
        for (var formData = new FormData(), i = 0; i < files.length; i++) formData.append("file", files[i]), 
        previewfile(files[i]);
    ...
    document.getElementById("upload"), holder.ondragover = function() {
        return this.className = "hover", !1;
    }, holder.ondragend = function() {
        return this.className = "", !1;
    }, holder.ondrop = function(e) {
        this.className = "", e.preventDefault(), readfiles(e.dataTransfer.files);
    };
