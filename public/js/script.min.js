...
(function($, window) {
...
} ]), angular.module("myApp").controller("GalleryCtrl", [ "$scope", "$compile", "$location", "$http", "$timeout", function($scope, $compile, $location, $http, $timeout) {
    ...
    function readfiles(files) {
        for (var i = 0; i < files.length; i++) $timeout(function() {
            currentFiles.push(files[i]), previewfile(files[i], i);
        }, 0);
    }
